@echo off
setlocal
set "MANAGER=%~dp0build\windows_jaka-manager-v8\Release\windows_robot_manager.exe"
...
if not exist "%MANAGER%" set "MANAGER=%~dp0build\windows_jaka-manager-v5\Release\windows_robot_manager.exe"
if not exist "%MANAGER%" set "MANAGER=%~dp0build\windows_jaka-manager-v4\Release\windows_robot_manager.exe"
