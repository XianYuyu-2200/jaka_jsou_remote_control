...
**Project:** JAKA Dual Teleop
**Generated:** 2026-09-09 22:06:33
...
| Secondary | `#008F11` | `--color-secondary` |
| On Secondary | `#000000` | `--color-on-secondary` |
| Accent/CTA | `#FF3333` | `--color-accent` |
| On Accent/CTA | `#000000` | `--color-on-accent` |
| Background | `#0D1117` | `--color-background` |
| Foreground | `#E6EDF3` | `--color-foreground` |
| Card | `#182424` | `--color-card` |
| Card Foreground | `#E6EDF3` | `--color-card-foreground` |
| Muted | `#25292F` | `--color-muted` |
...
**Color Notes:** Terminal green + alert red
